...
import {
    timerProgress, recordMulResp,
    showMoneyOutcome, showAfterClickDelay,
    setProgressStartTime, setTimerProgress
}
    from "../../../slices/gameSlice";
import { useRef, useEffect } from "react";

export default function TrialTimer({ xpConfig }) {
    ...
    return (
        <LinearProgress className='instant' style={{ width: '100%' }} variant={'determinate'} value={timerProgressS} color={timerProgressS >= 55 ? 'secondary' : 'primary'} />
    )
}